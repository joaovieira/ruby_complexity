  ...
  module Generators
	class InstallGenerator < Rails::Generators::Base
	  ...
	  def add_programming_language
		...
		p_language = RubyComplexity::PROGRAMMING_LANGUAGE
	  ...
	  def add_metric
		p_language = ProgrammingLanguage.find_by_name(RubyComplexity::PROGRAMMING_LANGUAGE)
		  
		begin
		  Metric.table_exists?
		  metric_analyser = RubyComplexity::ANALYSER
		  metric_name = RubyComplexity::NAME
	  ...
	  def end_install
		puts "#{RubyComplexity::ANALYSER}: #{RubyComplexity::PROGRAMMING_LANGUAGE} #{RubyComplexity::NAME} sucessfully installed!"
	  end
	end
  end
end
